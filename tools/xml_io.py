...
readtype_funcs = {ndarray: read_array, dict: read_dict, float: read_float, int: read_int, bool: read_bool, str: str.strip, tuple: read_tuple, uint : read_int}
...
writetype_funcs = {float: write_float, dict: write_dict, int: str, bool: write_bool, str: str.strip, tuple: write_tuple, uint : str}
